...
//Set up carousel arrows
var mySwiper = document.querySelector('.swiper-container').swiper;
const swipeNext = document.getElementById('next');
const swipePrev = document.getElementById('prev');

swipeNext.addEventListener('click', slideForward);
swipePrev.addEventListener('click', slideBackward);
